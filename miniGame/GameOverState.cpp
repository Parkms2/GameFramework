...
bool GameOverState::onEnter() {
	...
	GameObject* gameOverText = new AnimatedGraphic(new  LoaderParams(540, 200, 190, 30, "gameovertext"), 2);
	GameObject* button1 = new MenuButton(new LoaderParams(540, 300, 200, 80, "mainbutton"), s_gameOverToMain);
	GameObject* button2 = new MenuButton(new LoaderParams(540, 500, 200, 80, "restartbutton"), s_restartPlay);
